...
function BreathingDetails() {
    ...
    return (
        <div>
            <div className="w-full h-full max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-16">
                <div className="space-y-6">
                    <div className="space-y-2">
                        <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">{item.title}</h1>
                                ...
                                (
                                    <ol className="space-y-4 list-decimal pl-6">
                                        ...
                                        <li>
                                            ...
                                            <p className="text-muted-foreground">
                                                Inhale slowly through your nose, feeling your belly expand. Exhale
                                                slowly
                                                through your mouth, letting
                                                your belly contract.
                                            </p>
                                        </li>
                                        <li>
                                            ...
                                            <p className="text-muted-foreground">
                                                Concentrate on the sensation of air moving in and out of your body. If
                                                your
                                                mind wanders, gently bring
                                        ...
                                        <li>
                                            ...
                                            <p className="text-muted-foreground">
                                                Continue this breathing exercise for 10 minutes, taking slow, deep
                                                breaths.
                                            </p>
                                        </li>
                                    </ol>
